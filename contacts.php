                    ...
                    <div class="range range-sm-bottom spacing-20">
                      ...
                      <div class="cell-xs-12">
                        <div class="form-wrap">
                          ...
                          <label class="form-label" for="contact-message">Your Subject</label>
                        </div>
                      </div>
                      <div class="cell-sm-6">
                        <div class="form-wrap">
                  ...
                  <div class="range range-50">
                    ...
                    <div class="cell-xs-6 cell-sm-12">
                      ...
                      <div class="unit unit-middle unit-horizontal unit-spacing-xs unit-xs-top">
                        ...
                        <div class="unit__body"><a class="text-middle link link-gray-dark" href="contacts.html">dUBAI , UAE</a></div>
                      </div>
                    </div>
                    <div class="cell-xs-6 cell-sm-12">
